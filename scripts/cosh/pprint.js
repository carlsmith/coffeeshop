define(function(){
    ...
    // pprint - a hacked version of jsDump. It needs porting to CS still.
    
    /** __ORIGINAL LICENSE NOTICE__
     * jsDump
    ...
    function join( pre, arr, post ){
        ...
        var s = pprint.separator(),
            base = pprint.indent(),
            inner = pprint.indent(1);
    ...
    return pprint = {
            ...
            if ( type == 'object' || type == 'function' ) {
                ...
                switch ( kind ) {
                    ...
                    default:
                        ...
                        else if (window.jQuery && obj instanceof window.jQuery) return 'jquery';
                        else if ( 'ownerDocument' in obj && 'defaultView' in obj.ownerDocument && obj instanceof obj.ownerDocument.defaultView.Node ) return 'node';
                    }}
        ...
        up:function( a ){ this._depth_ += a || 1 },
        
        down:function( a ){ this._depth_ -= a || 1 },
        
        setParser:function( name, parser ){ this.parsers[name] = parser },
        ...
        // This is the list of parsers, to modify them, use pprint.setParser
        parsers:{
            ...
            'null':'null',
            undefined:'undefined',
            'function':function( fn ){ return 'function' }, // TODO: use js2cs to compile function's source
            array: array,
            nodelist: array,
            arguments: array,
            jquery:array,
            ...
            object:function( map ){
                ...
                if (this._depth_ >= this.maxDepth) {
                    ...
                    throw new Error("Object nesting exceeded pprint.maxDepth (" + pprint.maxDepth + ")");
                    }
