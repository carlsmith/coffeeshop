ace.define(
    ...
    function(e,t,n) {
        ...
        + '.ace-vibrant-ink .ace_keyword,.ace-vibrant-ink .ace_meta {color: #D88E5C}'
        ...
        + '.ace-vibrant-ink .ace_entity.ace_name.ace_function,.ace-vibrant-ink .ace_support.ace_function,.ace-vibrant-ink .ace_variable {color: #D0AA17}'
        + '.ace-vibrant-ink .ace_variable.ace_parameter {font-style: italic}'
        + '.ace-vibrant-ink .ace_string {color: #93A538}'
